...
namespace GSB_Manager.Models
{
    public class Appartient
    {
        ...
        public Appartient(int prescription_id, int medicine_id, int quantity) // c'est une surcharge du constructeur, ça permettrea la création d'objet Users qui sera instancié avec les valeurs passées en paramètre
        {
